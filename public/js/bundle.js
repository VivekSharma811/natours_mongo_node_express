...
var displayMap = function displayMap(location) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hypheno/cku0zuid23ezl18lhmujgvj23' // center: [77.1025, 28.7041],
    // zoom: 4
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in succsessfully!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Data updated succsessfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var logoutButton = document.querySelector('.nav__el--logout'); //const userDataForm = document.querySelector('form-user-data');
